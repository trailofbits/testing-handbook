...
Now, we link together the instrumented libpng, the harness, and the execution runtime from the [previous section](#code-coverage-using-llvm-sanitizercoverage).
