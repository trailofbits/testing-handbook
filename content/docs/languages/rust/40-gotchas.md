...
- [ ] Verify that proper checks are performed before type conversions to prevent loss of precision (e.g., `u64` to `f64`, as the mantissa of type `f64` is only 53f bits wide).
