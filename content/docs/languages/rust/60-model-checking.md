...
{{< hint danger >}}
Prusti does not support loops automatically. You have to specify [`body_invariants`](https://viperproject.github.io/prusti-dev/user-guide/tour/loop_invariants.html) to enable code verification.
{{< /hint >}}
...
* [`kani::assume`](https://model-checking.github.io/kani/tutorial-first-steps.html#assertions-assumptions-and-harnesses): For restricting (bounding) symbolic values. It is a bit similar to [Prusti’s preconditions](https://trailofbits.github.io/docs/languages/rust/rust-advanced-testing/#function-specifications).  
